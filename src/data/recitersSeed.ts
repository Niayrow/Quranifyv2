...
export const SEEDED_RECITERS: Reciter[] = [
  { id: 123, name: 'Mishary Al Afasi', letter: 'M', moshaf: [{ id: 123, name: "Rewayat Hafs A'n Assem - Psalmodié", server: 'https://server8.mp3quran.net/afs/', surah_list: FULL_SURAH_LIST }] },
  ...
  { id: 102, name: 'Maher Al Meaqli', letter: 'M', moshaf: [{ id: 102, name: "Rewayat Hafs A'n Assem - Psalmodié", server: 'https://server12.mp3quran.net/maher/', surah_list: FULL_SURAH_LIST }] },
