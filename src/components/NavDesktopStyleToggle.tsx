...
export const NavDesktopStyleToggle: React.FC<NavDesktopStyleToggleProps> = ({
  ...
  return (
    <div className="mt-4 hidden md:flex flex-col gap-2 rounded-2xl border border-[#30455c]/55 bg-[#0f1928]/75 px-3.5 py-3">
      ...
      <div
        className="flex w-full max-w-md items-center gap-1 rounded-full border border-[#cea687]/30 bg-[#0c1522]/90 p-1"
        role="group"
      ...
      >
        <button
          ...
          className={`min-h-9 flex-1 rounded-full px-3 py-1.5 text-[11px] font-bold transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#cea687] ${
            value === 'dock'
